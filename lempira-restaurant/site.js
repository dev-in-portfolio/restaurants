/* Lempira Restaurant — Interactive Scripts */

document.addEventListener('DOMContentLoaded', () => {
  // Mobile Navigation Drawer Toggle
  const toggleBtn = document.querySelector('.mobile-drawer-trigger');
  const drawerPane = document.querySelector('.mobile-lempira-drawer');
  ...
  accordionButtons.forEach((btn) => {
    btn.addEventListener('click', () => {
      ...
      const siblings = item.parentElement.querySelectorAll('.lempira-accordion');
