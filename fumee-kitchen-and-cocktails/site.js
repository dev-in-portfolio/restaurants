/* Fumée Kitchen & Cocktails — Interactive Scripts */

document.addEventListener('DOMContentLoaded', () => {
  // Mobile Navigation Drawer Toggle
  const toggleBtn = document.querySelector('.mobile-drawer-trigger');
  const drawerPane = document.querySelector('.mobile-fumee-drawer');
  ...
  accordionButtons.forEach((btn) => {
    btn.addEventListener('click', () => {
      ...
      const siblings = item.parentElement.querySelectorAll('.fumee-accordion');
