...
window.portalOverrides = [
  ...
  {
    name: "Organize the family-dining decision by time of day.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
  ...
  },
  {
    ...
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
    href: "flame-asian-bistro-and-bar/index.html",
    gradient: "linear-gradient(135deg,#172033,#334155 52%,#0f172a)",
    status: "qa"
  },
  {
  ...
  },
  {
    ...
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
    href: "free-range-brewing/index.html",
    gradient: "linear-gradient(135deg,#172033,#334155 52%,#0f172a)",
    status: "qa"
  },
  {
  ...
  {
    name: "Charlotte's Original Craft Brewpub",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom pizza studio and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍕",
  ...
  {
    name: "Unashamedly Bright Coffees",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom drink lab and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "☕",
  ...
  {
    name: "Great Beer Starts With Great People",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom drink lab and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "☕",
  ...
  },
  {
    ...
    description: "Six-page concept upgraded with a custom drink lab and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "☕",
    href: "intermezzo-pizzeria/index.html",
    gradient: "linear-gradient(135deg,#172033,#334155 52%,#0f172a)",
    status: "qa"
  },
  {
    name: "Make the Lebanese table feel generous before the first mezze arrives.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
  ...
  {
    name: "Enjoy Healthy, Fresh Middle-Eastern Food",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom grill guide and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🔥",
    href: "la-shish-kabob/index.html",
    gradient: "linear-gradient(135deg,#172033,#334155 52%,#0f172a)",
    status: "qa"
  },
  {
    name: "Lang Van Vietnamese Restaurant",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom grill guide and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🔥",
  ...
  {
    name: "Your Neighborhood Market & Deli",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom drink lab and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "☕",
  ...
  {
    name: "Make the crisp baguette and current location equally impossible to miss.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom drink lab and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "☕",
  ...
  {
    name: "Turn the counter conversation into a guided market experience.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
  ...
  {
    name: "Help the group decide what kind of night this is.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
  ...
  {
    name: "Miguel's Mexican & American",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flavor table and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🌮",
  ...
  {
    name: "Make the box decision before the best trays sell down.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
  ...
  {
    name: "Treat Charlotte restaurant history as the main ingredient.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom pizza studio and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍕",
  ...
  {
    name: "Authentic Tex-Mex. 230+ Tequilas. One Legendary Bar.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom drink lab and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "☕",
  ...
  {
    name: "The Palace Diner & Restaurant",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom drink lab and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "☕",
  ...
  {
    name: "One front door, two very different cravings.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
  ...
  {
    name: "The Portrait Gallery Matthews, NC",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
  ...
  },
  {
    ...
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
    href: "sante/index.html",
    gradient: "linear-gradient(135deg,#172033,#334155 52%,#0f172a)",
    status: "qa"
  },
  {
    name: "Put the tap list and tonight’s reason to visit on the same track.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
    href: "seaboard-brewing/index.html",
    gradient: "linear-gradient(135deg,#172033,#334155 52%,#0f172a)",
    status: "qa"
  },
  {
    name: "El Nevado Tacos & Oaxacan Kitchen",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flavor table and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🌮",
  ...
  {
    name: "The Dive N Pineville Diner",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom drink lab and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "☕",
  ...
  {
    name: "Let guests choose sushi, grill or both without reading a wall of text.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
  ...
  {
    name: "A German destination should feel like the trip begins online.",
    area: "Charlotte area",
    cuisine: "Six-Page Restaurant Experience",
    description: "Six-page concept upgraded with a custom flight planner and interactive planner. Static validation passed; desktop/mobile browser QA remains pending.",
    emoji: "🍺",
