/* MAS Tortilleria — Interactive Scripts */

document.addEventListener('DOMContentLoaded', () => {
  // Mobile Navigation Drawer Toggle
  const toggleBtn = document.querySelector('.mobile-drawer-trigger');
  const drawerPane = document.querySelector('.mobile-mas-drawer');
  ...
  accordionButtons.forEach((btn) => {
    btn.addEventListener('click', () => {
      ...
      const siblings = item.parentElement.querySelectorAll('.mas-accordion');
